...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function buildUiConfig(d, name) {
    return {
      ...
      secondaryThemeColor: hexToArgbInt(d.primaryColor),
      secondaryThemeColorNight: hexToArgbInt(d.primaryColorDark),
      showBottomView: true,
      showDiscovery: true,
      showHome: true,
      showRss: true,
      ...
      themeBackgroundColor: hexToArgbInt(d.cardColor),
      themeBackgroundColorNight: hexToArgbInt(d.cardColorDark),
      themeColor: hexToArgbInt(d.primaryColor),
      themeColorNight: hexToArgbInt(d.primaryColorDark),
      themeMode: '1',
      topBarBlurAlpha: 73,
      topBarBlurRadius: 29,
      topBarOpacity: 100,
